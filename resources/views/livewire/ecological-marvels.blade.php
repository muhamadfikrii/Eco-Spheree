<div class="bg-grid-pattern min-h-screen px-4 py-12 sm:px-6 lg:px-8 lg:py-36">
    <div x-data="ecologicalMarvels()" class="mx-auto max-w-7xl">
        <div class="fixed inset-0 -z-10 overflow-hidden">
            <div
                class="floating-element absolute -right-32 -top-40 h-80 w-80 rounded-full bg-gradient-to-br from-[#a8c0b8] to-[#7c9a92] opacity-10 blur-xl"
            ></div>
            <div
                class="floating-element absolute -bottom-40 -left-32 h-80 w-80 rounded-full bg-gradient-to-br from-[#7c9a92] to-[#5a7c74] opacity-10 blur-xl"
                style="animation-delay: 2s"
            ></div>
            <div
                class="floating-element absolute left-1/4 top-1/2 h-64 w-64 rounded-full bg-gradient-to-br from-[#5a7c74] to-[#3a5a53] opacity-5 blur-xl"
        ...
        <header class="fade-in mb-20 text-center">
            <div
                class="nature-bg relative mb-6 inline-flex h-24 w-24 items-center justify-center rounded-full"
            >
                <i class="fas fa-seedling z-10 text-4xl text-green-500"></i>
                <div
                    class="indonesia-flag absolute -right-1 -top-1 h-6 w-6 rounded-full"
                ></div>
            </div>
            <h1 class="heading-font mb-6 text-5xl font-medium md:text-6xl">
                <span class="gradient-text">Ecological</span>
                <span class="gradient-text mt-2 block"
                    >Marvels of Indonesia</span
                >
            </h1>
            <p class="mx-auto max-w-3xl text-xl leading-relaxed text-white/80">Explore the natural wonders of Indonesia and its mesmerizing ecosystems in the archipelago of wonders. Every island holds priceless charm.</p>
        </header>

        <nav class="fade-in mb-16" style="animation-delay: 0.2s">
            <ul class="flex flex-wrap justify-center gap-2 md:gap-6">
                <template x-for="(item, index) in navItems" :key="index">
                    <li class="rounded-lg border border-green-500">
                        <button
                            @click="setActiveItem(index)"
                            class="nav-item flex items-center gap-2 rounded-xl px-5 py-3 font-medium text-green-600"
        ...
        <main
            class="glass-effect content-transition overflow-hidden rounded-3xl shadow-xl"
        >
            <div
            ...
            >
                <div class="relative h-64 overflow-hidden md:h-80">
                    <div
                        ...
                        :style="activeIndex !== null
                            ? `background-image: url('${navItems[activeIndex].image}')`
                            : ''"
                    >
                        <div class="image-overlay absolute inset-0"></div>
                        <div class="z-10 p-4 text-center text-white">
                            <h2
                                class="heading-font mb-2 text-4xl font-medium md:text-5xl"
                                x-text="
                                    activeIndex !== null
                                ...
                                "
                            ></h2>
                            <p class="mx-auto max-w-2xl text-xl opacity-90" x-text="
                                    activeIndex !== null
                                        ? navItems[activeIndex].subtitle
                                        : ''
                                "></p>
                            <div
                ...
                <div class="p-8 md:p-12">
                    <div
                        class="grid grid-cols-1 gap-8 md:gap-12 lg:grid-cols-3"
                    >
                        <div class="space-y-8 lg:col-span-2">
                            <div>
                                <h3
                                    class="heading-font mb-4 border-l-4 border-[#7c9a92] pl-4 text-2xl text-[#3a5a53]"
                                >
                                    Description
                                </h3>
                                <div
                                    class="space-y-4 leading-relaxed text-[#4a6a62]"
                                >
                                    <template
                                        x-for="
                                            (paragraph, pIndex) in
                                    ...
                                    >
                                        <p x-text="
                                                paragraph
                                            " class="stagger-item" :style="`animation-delay: ${pIndex * 0.1}s`"></p>
                                    </template>
                                </div>
                            </div>

                            <div
                                class="mt-8 grid grid-cols-2 gap-4 md:grid-cols-4"
                            >
                                <template
                                    x-for="
                                        (stat, sIndex) in
                                        (activeIndex !== null
                                            ? navItems[activeIndex].stats
                                            : [])
                                    "
                                    :key="sIndex"
                                >
                                    <div
                                        class="eco-card rounded-xl border border-[#e2e8e6] bg-white/50 p-4 text-center"
                                    >
                                        <div
                                            class="mb-1 text-2xl font-bold text-[#3a5a53]"
                                            x-text="stat.value"
                                        ></div>
                                        <div
                                            class="text-sm text-[#7c9a92]"
                                            x-text="stat.label"
                                        ></div>
                                    </div>
                                </template>
                                ...
                                >
                                    <template
                                        x-for="
                                            (photo, pIndex) in
                                            (activeIndex !== null
                                                ? navItems[activeIndex].gallery
                                                : [])
                                        "
                                        :key="pIndex"
                                    >
                                        <div
                                            class="eco-card h-32 overflow-hidden rounded-xl bg-gray-200 bg-cover bg-center md:h-40"
                        ...
                        <div class="space-y-8">
                            <div
                                class="eco-card glass-effect rounded-2xl border border-[#e2e8e6] p-6"
                            >
                                <h3
                                    class="heading-font mb-4 flex items-center gap-2 text-xl text-[#3a5a53]"
                                >
                                ...
                                <ul class="space-y-3">
                                    <template
                                        x-for="
                                            (feature, fIndex) in
                                            (activeIndex !== null
                                                ? navItems[activeIndex].features
                                                : [])
                                        "
                                        :key="fIndex"
                                    >
                                        <li
                                            class="stagger-item flex items-start"
                                            :style="`animation-delay: ${0.5 + fIndex * 0.1}s`"
                                        >
                                            <i
                                                class="fas fa-check mr-3 mt-1.5 flex-shrink-0 text-sm text-[#7c9a92]"
                                            ></i>
                                            <span
                                                class="text-[#4a6a62]"
                                                x-text="feature"
                            ...
                            >
                                ...
                                >
                                    <i
                                        class="fas fa-exclamation-triangle text-[#c97a6a]"
                                    ></i>
                                    <span>Threats</span>
                                </h3>
                                <ul class="space-y-3">
                                    ...
                                    >
                                        <li
                                            class="stagger-item flex items-start"
                                            :style="`animation-delay: ${0.7 + tIndex * 0.1}s`"
                                        >
                                            <i
                                                class="fas fa-times mr-3 mt-1.5 flex-shrink-0 text-sm text-[#c97a6a]"
                                            ></i>
                                            <span
                                                class="text-[#4a6a62]"
                                                x-text="threat"
                            ...
                            >
                                ...
                                >
                                    <i
                                        class="fas fa-map-marker-alt text-[#7c9a92]"
                                    ></i>
                                ...
                                <div class="space-y-2">
                                    ...
                                    >
                                        <div
                                            class="stagger-item flex items-center text-[#4a6a62]"
                                            :style="`animation-delay: ${0.9 + lIndex * 0.1}s`"
                                        >
                                            <i
                                                class="fas fa-map-pin mr-2 text-xs text-[#7c9a92]"
                                            ></i>
                            ...
                            >
                                ...
                                >
                                    <i
                                        class="fas fa-calendar-alt text-[#7c9a92]"
                                    ></i>
                                    <span>Best Time to Visit</span>
                                </h3>
                                <div
                                    class="stagger-item text-[#4a6a62]"
                                    :style="`animation-delay: 1.1s`"
                                    x-text="
                                        activeIndex !== null
                                            ? navItems[activeIndex].bestTime
                                            : ''
                                    "
                                ></div>
                            </div>
                    ...
                    <div
                        class="mt-12 border-t border-[#e2e8e6] pt-8 text-center"
                    >
                        <p class="mb-6 text-[#5a7c74]">Want to learn more about the ecological wonders of Indonesia?</p>
                        <a
                            href="{{ route('deeper') }}"
                            class="transform rounded-xl bg-gradient-to-r from-[#7c9a92] to-[#5a7c74] px-6 py-3 font-medium text-white transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
                        >
            ...
            <div
                x-show="activeIndex === null"
                class="px-4 py-16 text-center md:py-24"
            >
                <div class="mx-auto max-w-2xl">
                    <div
                        class="floating-element nature-bg mb-8 inline-flex h-24 w-24 items-center justify-center rounded-full"
                    >
                        <i class="fas fa-leaf text-4xl text-green-800"></i>
                    </div>
                    <h3
                        class="heading-font mb-6 text-3xl text-slate-800 md:text-4xl"
                    >
                        Select a Category to Explore
                    </h3>
                    <p class="mb-8 text-xl text-gray-700">Click on one of the navigations above to start exploring the ecological wonders of Indonesia</p>
                </div>
            </div>
        </main>
    </div>
                ...
                navItems: [
                    {
                        ...
                        subtitle:
                            'The lungs of the world, full of life and biodiversity',
                    ...
                    },
                    {
                        ...
                        subtitle:
                            "The center of the world's highest marine biodiversity",
                        province: 'West Papua',
                        icon: 'fas fa-water',
                    ...
                    },
                    {
                        title: 'Lake Toba',
                        subtitle:
                            'The largest volcanic lake in the world and a Batak cultural heartland',
                    ...
                    },
                    {
                        title: 'Labuan Bajo',
                        subtitle:
                            'Gateway to Komodo National Park and one of Indonesia’s top diving paradises',
    ...
    <style>
        ...
        .nature-bg {
            background: linear-gradient(
                135deg,
                rgba(122, 161, 149, 0.7) 0%,
                rgba(90, 124, 116, 0.1) 100%
            );
        }
        .eco-card {
            transition: all 0.4s ease;
