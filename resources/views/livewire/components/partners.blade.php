    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
            <div class="grid grid-cols-2 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                ...
                >
                    <div
                        class="mb-3 flex h-16 w-16 items-center justify-center rounded-xl bg-white p-3"
                    >
                        <img
                            src="https://1000logos.net/wp-content/uploads/2021/11/Siemens-logo.jpg"
                            alt="Siemens"
                ...
                >
                    ...
                    >
                        <img
                            src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Microsoft_logo.svg/3840px-Microsoft_logo.svg.png"
                            alt="Microsoft"
                            class="h-full w-full object-contain"
                        />
                    </div>
