        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-[#0f2a3d]/80 rounded-2xl shadow-2xl border border-[#4a8c6d]/20 p-6 sm:p-8 lg:p-12 mb-12 backdrop-blur-sm">
                    ...
                    <div class="group flex flex-col items-center justify-center p-4 sm:p-6 hover:scale-105 transition-all duration-300 bg-white/5 rounded-xl border border-[#4a8c6d]/10 hover:border-[#e6b325]/30 hover:bg-white/10">
                        <div class="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 bg-white rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 border-2 border-[#4a8c6d]/20 group-hover:border-[#e6b325]/40 p-3">
                            <img 
                                ...
                                loading="lazy"
                                onerror="this.src='https://via.placeholder.com/150/1a3c34/FFFFFF?text=KLHK'"
                            >
                        </div>
                        <p class="text-xs text-[#e8f4f0] font-medium text-center mt-2 leading-tight">Ministry of Environment & Forestry</p>
                    </div>
                    ...
                    <div class="group flex flex-col items-center justify-center p-4 sm:p-6 hover:scale-105 transition-all duration-300 bg-white/5 rounded-xl border border-[#4a8c6d]/10 hover:border-[#e6b325]/30 hover:bg-white/10">
                        <div class="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 bg-white rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 border-2 border-[#4a8c6d]/20 group-hover:border-[#e6b325]/40 p-3">
                            <img 
                                ...
                                class="w-full h-full object-contain filter group-hover:brightness-110 transition-all duration-300"
                                loading="lazy"
                                onerror="this.src='https://via.placeholder.com/150/1a3c34/FFFFFF?text=WWF'"
                            >
                        </div>
                        <p class="text-xs text-[#e8f4f0] font-medium text-center mt-2 leading-tight">WWF Indonesia</p>
                    </div>
                    ...
                    <div class="group flex flex-col items-center justify-center p-4 sm:p-6 hover:scale-105 transition-all duration-300 bg-white/5 rounded-xl border border-[#4a8c6d]/10 hover:border-[#e6b325]/30 hover:bg-white/10">
                        <div class="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 bg-white rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 border-2 border-[#4a8c6d]/20 group-hover:border-[#e6b325]/40 p-3">
                            <img 
                                ...
                                class="w-full h-full object-contain filter group-hover:brightness-110 transition-all duration-300"
                                loading="lazy"
                                onerror="this.src='https://via.placeholder.com/150/1a3c34/FFFFFF?text=UI'"
                            >
                        </div>
                        <p class="text-xs text-[#e8f4f0] font-medium text-center mt-2 leading-tight">University of Indonesia</p>
                    </div>
                    ...
                    <div class="group flex flex-col items-center justify-center p-4 sm:p-6 hover:scale-105 transition-all duration-300 bg-white/5 rounded-xl border border-[#4a8c6d]/10 hover:border-[#e6b325]/30 hover:bg-white/10">
                        <div class="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 bg-white rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 border-2 border-[#4a8c6d]/20 group-hover:border-[#e6b325]/40 p-3">
                            <img 
                                ...
                                alt="Eco Corporation"
                                class="w-full h-full object-contain filter group-hover:brightness-110 transition-all duration-300 rounded-lg"
                                loading="lazy"
                                onerror="this.src='https://via.placeholder.com/150/1a3c34/FFFFFF?text=ECO'"
                            >
                        </div>
                        <p class="text-xs text-[#e8f4f0] font-medium text-center mt-2 leading-tight">Eco Corporation</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6 mt-10 sm:mt-12 pt-8 sm:pt-12 border-t border-[#4a8c6d]/20">
                    ...
                    <div class="group flex flex-col items-center justify-between p-3 sm:p-4 hover:scale-105 transition-all duration-300 h-full bg-white/5 rounded-lg border border-[#4a8c6d]/10 hover:border-[#e6b325]/20 hover:bg-white/10">
                        ...
                        <p class="text-xs text-[#e8f4f0] font-medium text-center mt-2 leading-tight">UNDP</p>
                    </div>
                    ...
                    <div class="group flex flex-col items-center justify-between p-3 sm:p-4 hover:scale-105 transition-all duration-300 h-full bg-white/5 rounded-lg border border-[#4a8c6d]/10 hover:border-[#e6b325]/20 hover:bg-white/10">
                        ...
                        <p class="text-xs text-[#e8f4f0] font-medium text-center mt-2 leading-tight">World Bank</p>
                    </div>
                    ...
                    <div class="group flex flex-col items-center justify-between p-3 sm:p-4 hover:scale-105 transition-all duration-300 h-full bg-white/5 rounded-lg border border-[#4a8c6d]/10 hover:border-[#e6b325]/20 hover:bg-white/10">
                        ...
                        <p class="text-xs text-[#e8f4f0] font-medium text-center mt-2 leading-tight">Google</p>
                    </div>
                    ...
                    <div class="group flex flex-col items-center justify-between p-3 sm:p-4 hover:scale-105 transition-all duration-300 h-full bg-white/5 rounded-lg border border-[#4a8c6d]/10 hover:border-[#e6b325]/20 hover:bg-white/10">
                        ...
                        <p class="text-xs text-[#e8f4f0] font-medium text-center mt-2 leading-tight">Amazon</p>
                    </div>
                    ...
                    <div class="group flex flex-col items-center justify-between p-3 sm:p-4 hover:scale-105 transition-all duration-300 h-full bg-white/5 rounded-lg border border-[#4a8c6d]/10 hover:border-[#e6b325]/20 hover:bg-white/10">
                        ...
                        <p class="text-xs text-[#e8f4f0] font-medium text-center mt-2 leading-tight">Apple</p>
                    </div>
                    ...
                    <div class="group flex flex-col items-center justify-between p-3 sm:p-4 hover:scale-105 transition-all duration-300 h-full bg-white/5 rounded-lg border border-[#4a8c6d]/10 hover:border-[#e6b325]/20 hover:bg-white/10">
                        ...
                        <p class="text-xs text-[#e8f4f0] font-medium text-center mt-2 leading-tight">IBM</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-[#0f2a3d] rounded-2xl shadow-2xl p-6 sm:p-8 lg:p-12 text-[#e8f4f0] mb-12 border border-[#4a8c6d]">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 text-center">
                    ...
                    <div class="group hover:scale-105 transition-transform duration-300">
                        <div class="text-2xl lg:text-3xl font-bold mb-2 text-[#e6b325]">15</div>
                        <div class="text-[#a0b8b0] text-sm">Government Agencies</div>
                    </div>
                    <div class="group hover:scale-105 transition-transform duration-300">
                        <div class="text-2xl lg:text-3xl font-bold mb-2 text-[#e6b325]">25</div>
                        <div class="text-[#a0b8b0] text-sm">NGO Collaborations</div>
                    </div>
                    <div class="group hover:scale-105 transition-transform duration-300">
                        <div class="text-2xl lg:text-3xl font-bold mb-2 text-[#e6b325]">10+</div>
                        <div class="text-[#a0b8b0] text-sm">Global Corporations</div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                <div class="text-center lg:text-left group hover:transform hover:-translate-y-2 transition-all duration-300 bg-[#0f2a3d]/60 p-6 rounded-2xl border border-[#4a8c6d]/20 hover:border-[#e6b325]/30">
                    ...
                    <h3 class="font-bold text-[#e8f4f0] text-lg mb-3">Government Certified</h3>
                    <p class="text-[#a0b8b0] text-sm leading-relaxed">
                        Officially recognized and supported by Indonesian government agencies for environmental monitoring and sustainability initiatives.
                    </p>
                </div>

                <div class="text-center lg:text-left group hover:transform hover:-translate-y-2 transition-all duration-300 bg-[#0f2a3d]/60 p-6 rounded-2xl border border-[#4a8c6d]/20 hover:border-[#e6b325]/30">
                    <div class="w-12 h-12 bg-[#4a8c6d]/20 rounded-2xl flex items-center justify-center mx-auto lg:mx-0 mb-4 group-hover:bg-[#e6b325]/20 transition-colors duration-300 border border-[#4a8c6d]/30">
                        <i class="fas fa-handshake text-[#e6b325] text-xl"></i>
                    </div>
                    <h3 class="font-bold text-[#e8f4f0] text-lg mb-3">Strategic Alliances</h3>
                    <p class="text-[#a0b8b0] text-sm leading-relaxed">
                        Collaborative partnerships with leading NGOs, research institutions, and global corporations for maximum environmental impact.
                    </p>
                </div>

                <div class="text-center lg:text-left group hover:transform hover:-translate-y-2 transition-all duration-300 bg-[#0f2a3d]/60 p-6 rounded-2xl border border-[#4a8c6d]/20 hover:border-[#e6b325]/30">
                    <div class="w-12 h-12 bg-[#4a8c6d]/20 rounded-2xl flex items-center justify-center mx-auto lg:mx-0 mb-4 group-hover:bg-[#e6b325]/20 transition-colors duration-300 border border-[#4a8c6d]/30">
                        <i class="fas fa-chart-line text-[#e6b325] text-xl"></i>
                    </div>
                    <h3 class="font-bold text-[#e8f4f0] text-lg mb-3">Proven Results</h3>
                    <p class="text-[#a0b8b0] text-sm leading-relaxed">
                        Track record of successful implementations and measurable environmental improvements across multiple regions and ecosystems.
                    </p>
                </div>
            </div>
