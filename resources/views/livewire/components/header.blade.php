<div>
    <section
        id="heroSection"
        class="relative flex min-h-[85vh] items-center justify-center overflow-hidden py-12 sm:min-h-screen sm:py-20"
    >
        ...
        <div class="hero-bg absolute inset-0 z-0">
            <div
                ...
                style="
                    background-image: url('https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?w=1600&q=80');
                    transform: scale(1);
                "
            ></div>
        </div>
        ...
        <div
            class="absolute inset-0 z-10 bg-gradient-to-b from-black/60 via-black/30 to-black/80"
        ></div>
        <div
            class="absolute inset-0 z-10 bg-gradient-to-t from-slate-950/70 to-transparent"
        ></div>
        ...
        <!-- Konten utama -->
        <div
            class="hero-content relative z-20 mx-auto max-w-7xl px-6 text-center"
        >
            <div
            ...
            <h1
                class="hero-title mb-6 text-4xl font-bold leading-tight text-white drop-shadow-lg sm:text-5xl md:text-7xl"
            >
                Industrial
                <span
            ...
            <p class="hero-description mx-auto mb-8 max-w-2xl text-base text-gray-100 drop-shadow-md sm:text-xl">Transform your factory floor with AI-powered insights, predictive maintenance, and live machine telemetry. Maximize OEE and reduce downtime.</p>
            <div class="hero-buttons flex flex-wrap justify-center gap-2">
                <a
                    href="#dashboard"
                    class="btn-primary inline-flex items-center justify-center rounded-lg px-4 py-2 text-xs font-medium shadow-lg shadow-cyan-500/20 transition-all duration-300 sm:px-6 sm:py-3 sm:text-sm"
                >
                    Launch Dashboard
                ...
                <a
                    href="#features"
                    class="btn-secondary inline-flex items-center justify-center rounded-lg border border-gray-300 px-4 py-2 text-xs font-medium text-white backdrop-blur-sm transition-all duration-300 hover:bg-white/10 sm:px-6 sm:py-3 sm:text-sm"
                >
                    Explore Solutions
                </a>
            </div>
            <div
                class="hero-stats mt-12 flex justify-center gap-8 text-sm text-gray-200"
            >
                <div class="stat-item flex items-center gap-2">
                    <i class="fas fa-chart-line text-cyan-400"></i
                    ><span class="stat-number font-bold text-white">2.5M+</span>
                    data pts/sec
                </div>
                <div class="stat-item flex items-center gap-2">
                    <i class="fas fa-industry text-cyan-400"></i
                    ><span class="stat-number font-bold text-white"
                        >1,200+</span
                    >
                    connected factories
                </div>
                <div class="stat-item flex items-center gap-2">
                    ...
                    ><span class="stat-number font-bold text-white">99.5%</span>
                    uptime
                </div>
            </div>
        </div>
        ...
        <div class="absolute bottom-8 left-1/2 z-20 -translate-x-1/2 transform">
            <div
                class="scroll-indicator flex h-10 w-6 justify-center rounded-full border-2 border-cyan-400"
            >
                <div
                    class="scroll-dot mt-2 h-2 w-1 rounded-full bg-cyan-400"
                ></div>
            </div>
        </div>
    </section>
