<x-app-layout>
        ...
        <div class="relative z-10 container mx-auto px-4 sm:px-6 py-16 sm:py-24 lg:py-32">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
                    Protect Our 
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 to-teal-300">Natural Heritage</span>
                </h1>
                
                <p class="text-lg sm:text-xl md:text-2xl text-emerald-100 mb-8 max-w-3xl mx-auto leading-relaxed">
                    Join our mission to safeguard vital ecosystems, protect endangered species, and preserve our planet's biodiversity for future generations.
                </p>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                        ...
                        <div class="text-sm text-emerald-200">Protected Areas</div>
                    </div>
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                        <div class="text-2xl font-bold text-white">85%</div>
                        <div class="text-sm text-emerald-200">Species Protection Rate</div>
                    </div>
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                        <div class="text-2xl font-bold text-white">45</div>
                        <div class="text-sm text-emerald-200">Endangered Species Saved</div>
                    </div>
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                        <div class="text-2xl font-bold text-white">95%</div>
                        <div class="text-sm text-emerald-200">Community Participation</div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="flex flex-col md:flex-row items-start gap-8">
                        ...
                        <div class="md:w-1/3">
                            <div class="bg-white rounded-xl p-6 shadow-md border border-emerald-100">
                                ...
                                <a href="{{ route('challenge') }}" class="mt-6 w-full bg-emerald-600 hover:bg-emerald-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-300 flex items-center justify-center">
    ...
    <section class="py-16 sm:py-24 bg-white">
        <div class="container mx-auto px-4 sm:px-6">
            <div class="text-center mb-16">
                <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Our Protection Methods</h2>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                    Combining traditional knowledge with modern technology for effective conservation
                </p>
            </div>
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 border border-emerald-100">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl font-bold text-gray-900">Community-Based Protection</h3>
                        </div>
                        <p class="text-gray-700">
                            Empowering local communities to become stewards of their natural resources through education, training, and sustainable livelihood opportunities.
                        </p>
                        <ul class="mt-4 space-y-2">
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-700">Local patrols and monitoring</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-5 h-5 text-emerald-500 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                </svg>
                                <span class="text-gray-700">Traditional ecological knowledge</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-5 h-5 text-emerald-500 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                </svg>
                                <span class="text-gray-700">Sustainable resource management</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-6 border border-blue-100">
                        ...
                        <p class="text-gray-700">
                            Leveraging cutting-edge technology for monitoring, data collection, and analysis to enhance conservation efforts and respond to threats more effectively.
                        </p>
                        <ul class="mt-4 space-y-2">
                            <li class="flex items-start">
                            ...
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-700">Camera traps and sensors</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-5 h-5 text-blue-500 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                </svg>
                                <span class="text-gray-700">Data analytics and AI</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-2xl p-6 border border-purple-100">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl font-bold text-gray-900">Policy & Advocacy</h3>
                        </div>
                        <p class="text-gray-700">
                            Working with governments, organizations, and stakeholders to develop and implement policies that support conservation and sustainable development.
                        </p>
                        <ul class="mt-4 space-y-2">
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-700">Environmental legislation</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-5 h-5 text-purple-500 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                </svg>
                                <span class="text-gray-700">Protected area management</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-5 h-5 text-purple-500 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                </svg>
                                <span class="text-gray-700">International cooperation</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-6 border border-amber-100">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl font-bold text-gray-900">Restoration & Rehabilitation</h3>
                        </div>
                        <p class="text-gray-700">
                            Actively restoring degraded ecosystems and rehabilitating wildlife to rebuild biodiversity and ecosystem services for future generations.
                        </p>
                        <ul class="mt-4 space-y-2">
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-700">Reforestation and afforestation</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-5 h-5 text-amber-500 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                </svg>
                                <span class="text-gray-700">Wildlife rehabilitation centers</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-5 h-5 text-amber-500 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                </svg>
                                <span class="text-gray-700">Ecosystem recovery programs</span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="py-16 sm:py-24 bg-gradient-to-b from-gray-50 to-white">
        <div class="container mx-auto px-4 sm:px-6">
            <div class="text-center mb-16">
                <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Protection Success Stories</h2>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                    Real impact from our conservation efforts around the world
                </p>
            </div>
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                        <div class="flex items-center mb-4">
                            ...
                            <div>
                                <h3 class="text-xl font-bold text-gray-900">Amazon Rainforest Protection</h3>
                                <p class="text-gray-600">Brazil, South America</p>
                            </div>
                        </div>
                        <p class="text-gray-700 mb-4">
                            Through community engagement and satellite monitoring, we've helped reduce deforestation rates by 65% in protected areas of the Amazon, preserving critical habitat for thousands of species.
                        </p>
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                        <div class="flex items-center mb-4">
                            ...
                            <div>
                                <h3 class="text-xl font-bold text-gray-900">Coral Reef Restoration</h3>
                                <p class="text-gray-600">Philippines, Southeast Asia</p>
                            </div>
                        </div>
                        <p class="text-gray-700 mb-4">
                            Our marine protection program has successfully restored 450 acres of coral reefs, increasing fish populations by 80% and supporting local fishing communities while protecting biodiversity.
                        </p>
                        <div class="flex justify-between text-sm text-gray-500">
    ...
    <section class="py-16 sm:py-24 bg-gradient-to-r from-emerald-600 to-teal-600 text-white">
        <div class="container mx-auto px-4 sm:px-6 text-center">
            <h2 class="text-3xl sm:text-4xl font-bold mb-6">Ready to Protect Our Planet?</h2>
            <p class="text-xl mb-8 max-w-2xl mx-auto opacity-90">
                Join thousands of volunteers and conservationists working to protect endangered species and preserve vital ecosystems.
            </p>
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="{{ route('challenge') }}" class="px-8 py-3 bg-white text-emerald-700 font-semibold rounded-lg hover:bg-emerald-50 transition-colors duration-300 shadow-lg flex items-center justify-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                    </svg>
                    Join Protection Efforts
                </a>
                <a href="#protection-areas" class="px-8 py-3 bg-transparent text-white font-semibold rounded-lg hover:bg-white/10 transition-colors duration-300 border-2 border-white flex items-center justify-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
