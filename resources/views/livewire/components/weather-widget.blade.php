...
>
    ...
    >
        <div class="flex items-center gap-3">
            ...
            >
                <i class="fas fa-cloud-sun text-lg text-sky-600"></i>
            </div>
            <div>
    ...
    @elseif ($error)
        <div class="py-10 text-center">
            <i
                class="fas fa-exclamation-triangle mb-3 text-3xl text-rose-500"
            ></i>
            <p class="text-sm text-slate-700">{{ $error }}</p>
            <button
                wire:click="fetchWeatherData"
                class="mt-2 rounded-lg bg-sky-500 px-4 py-2 text-sm text-white"
            >
                Try Again
            </button>
        </div>
    @elseif ($weatherData)
        <div class="space-y-4 text-center">
            <div>
                ...
                <p class="text-sm capitalize text-slate-500">{{ $weatherData['weather'][0]['description'] }}</p>
            </div>
            ...
            <div>
                <div class="text-5xl font-bold sm:text-6xl">
                    {{ round($weatherData['main']['temp']) }}°
                </div>
                <p class="text-sm text-slate-500">Feels like {{ round($weatherData['main']['feels_like']) }}°</p>
            </div>
