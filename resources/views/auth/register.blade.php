    ...
    <div class="flex min-h-screen">
        ...
        >
            <div class="w-full max-w-md">
                ...
                <div class="mb-8 text-center">
                    Join NovaForge launch your smart industry profile
                </div>
                ...
                >
                    ...
                    <div class="mb-4" x-data="{ focused: false }">
                        ...
                        <div class="relative">
                            ...
                            <input
                                id="name"
                                class="mt-1 block w-full rounded-lg border border-slate-700 bg-slate-800/50 pl-10 text-white placeholder-gray-500 transition-all duration-200 focus:border-emerald-500 focus:outline-none focus:ring-0"
                                type="text"
                                name="name"
                                value="{{ old('name') }}"
                                required
                    ...
                    >
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="mt-1 block w-full rounded-lg border border-slate-700 bg-slate-800/50 pl-10 pr-10 text-white placeholder-gray-500 transition-all duration-200 focus:border-emerald-500 focus:outline-none focus:ring-0"
                                name="password"
                                required
                    ...
                    <div
                        class="mb-6"
                        x-data="{ focused: false, showConfirmPassword: false }"
                    >
                        <x-input-label
                        ...
                        <div class="flex items-start">
                            <div class="flex h-5 items-center">
                                <input
                                    ...
                                    name="terms"
                                    type="checkbox"
                                    class="h-4 w-4 rounded border-slate-600 bg-slate-800 text-emerald-500 focus:border-emerald-500 focus:ring-emerald-500"
                                />
                            </div>
                            <div class="ml-3 text-sm">
                                <label for="terms" class="text-gray-400">
                                    ...
                                    <button
                                        ...
                                        class="text-emerald-400 underline transition-colors hover:text-emerald-300"
                                    >
                                        Terms of Service
                                    </button>
                                    and
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                ...
                                class="inline-block transform overflow-hidden rounded-lg bg-slate-800 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:align-middle"
                            >
                                <div
                                    class="bg-slate-800 px-4 pb-4 pt-5 sm:p-6 sm:pb-4"
                                >
                                    <div class="sm:flex sm:items-start">
                                        ...
                                        >
                                            <h3
                                                class="mb-4 text-lg font-medium leading-6 text-white"
                                            >
                                                Terms of Service
                                            </h3>
                                            <div
                                                class="mt-2 max-h-96 overflow-y-auto text-sm text-gray-300"
                                            >
                                                <h4
                                                    class="mb-2 font-semibold text-emerald-400"
                                                >
                                ...
                                <div
                                    class="bg-slate-700 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6"
                                >
                                    <button
                                        type="button"
                                        @click="showTermsModal = false"
        ...
        <div class="relative hidden overflow-hidden lg:block lg:w-1/2">
            ...
            >
                ...
                <p class="max-w-md text-xl text-gray-200">Be part of a community dedicated to making sustainable choices for a better future</p>
