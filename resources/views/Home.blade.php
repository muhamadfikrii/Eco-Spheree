...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 relative"
    ...
    <!-- CTA Floating Box -->
    <div class="absolute top-[24rem] lg:top-[26rem] right-8 lg:right-20 z-10 hidden lg:block" data-aos="fade-left" data-aos-delay="500">
    ...
    <!-- Divider -->
    <div class="bg-black mt-10 h-[1px] mx-4 sm:mx-10 lg:mx-20" data-aos="fade-in" data-aos-delay="200"></div>

    <section x-data="{ show: false }" x-init="setTimeout(() => show = true, 200)" id="map-section" class="text-center py-16 sm:py-20 relative overflow-hidden px-4 sm:px-6 lg:px-8" data-aos="fade-up" data-aos-delay="400">
    ...
    <!-- Main Grid Section -->
    <div class="mx-auto pb-10" data-aos="fade-up" data-aos-delay="600">
        ...
        <div class="bg-black mt-10 h-[1px]" data-aos="fade-in" data-aos-delay="1200"></div>
    </div>
