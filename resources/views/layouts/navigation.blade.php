    ...
    <div class="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center space-x-6 bg-slate-900 px-8 py-2 rounded-full backdrop-blur-sm border border-slate-800/50 font-medium text-[15px]">
                <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="text-slate-300 hover:text-emerald-400 transition">Dashboard</x-nav-link>
            ...
            <div class="hidden md:flex items-center ml-8 space-x-4">
                @auth
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-4 py-2 bg-slate-800/70 hover:bg-slate-700 rounded-lg text-slate-200 transition-all duration-200">
                                {{ Auth::user()->name }}
