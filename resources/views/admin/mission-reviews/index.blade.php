                                    ...
                                    <div class="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md transition-all duration-200">
                                        <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between">
                                            ...
                                            <div class="mt-4 lg:mt-0 lg:ml-6 flex flex-col space-y-3">
                                                ...
                                                <!-- PERBAIKAN: Tombol reject tanpa form, hanya untuk membuka modal -->
                                                <button type="button" 
                                                        class="w-full px-4 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-lg font-medium flex items-center justify-center transition-colors duration-200" 
        ...
        <div x-show="rejectModalOpen" x-cloak class="fixed inset-0 z-50 overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="rejectModalOpen" 
                     ...
                     class="inline-block align-bottom bg-white rounded-xl px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6" style="margin-top: 120px;">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="mt-2">
                                ...
                                <!-- PERBAIKAN: Form reject dengan action yang benar -->
                                <form method="POST" :action="rejectUrl" class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            required
                                            x-model="rejectionReason" style="color: black;"></textarea>
                                    </div>
